...
public class RoundRobin implements CpuAlgorithm{
	...
	public void run(ArrayList<Job> arlistJob, double dblTotalBurstTime){
		...
		queueJob = new ArrayDeque<Job>(arlistJob.size());
	...
	private double processJob(Job objJob, double dblProcessTime){
		...
		getPossibleNextJob(objJob, dblProcessTime);
	...
	public void getPossibleNextJob(Job objJob, double dblProcessTime){
